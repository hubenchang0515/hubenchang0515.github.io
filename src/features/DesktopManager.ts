...
export default class DesktopManager {
    ...
    startProcess(app:ApplicationProps, componentProps?:any) {
        ...
        const process:Process = {
            ...
            x: app.x ?? (top === null || top.x + (app.width ?? 1080) > document.body.clientWidth ? 100 : top.x + 40),
            y: app.y ?? (top === null || top.y + (app.height ?? 720) > document.body.clientHeight ? 100 : top.y + 40),
